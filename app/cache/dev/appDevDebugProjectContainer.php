...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'my_symfony', 'user' => 'root', 'password' => 'admin', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/MySymphony/BlogBundle/Resources/config/doctrine') => 'MySymphony\\BlogBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'MySymphony\\BlogBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('MySymphonyBlogBundle' => 'MySymphony\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b2761cf0ee3b6ca053d5d884bfda6e771d9af0edc11a008f27b8c72a24de9d03');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MySymphony/BlogBundle/Resources/views'), 'MySymphonyBlog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('74f8f18de228c1f06bd99dec4e027f934a141e1f');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'MySymphonyBlogBundle' => 'MySymphony\\BlogBundle\\MySymphonyBlogBundle',
            ...
            'locale' => 'en',
            'secret' => '74f8f18de228c1f06bd99dec4e027f934a141e1f',
            'database_path' => NULL,
            ...
            'kernel.secret' => '74f8f18de228c1f06bd99dec4e027f934a141e1f',
